...
void    pspUARTWriteBuffer(char *data, int len);      // Writes a buffer 1 character at a time using pspUARTWrite()
void    pspUARTPrint(char *str);                      // Write buffer and automatically determine length
